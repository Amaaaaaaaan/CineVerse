    ...
    <>
      <div className="w-[20%] max-md:w-[25%] max-md:p-2 h-full border-r-2 border-zinc-400 p-5 overflow-x-hidden">
        ...
        <nav className="flex flex-col text-x1 gap-2 max-md:gap-1 max-md:mt-[-10px]">
          ...
          <Link
            to="/movie"
            className="hover:bg-[#6556CD] Thover: text-zinc-300 duration-300 rounded-md p-3 max-md:mb-2 max-md:p-1"
          >
          ...
          <Link
            to="peoples"
            className="hover:bg-[#6556CD] Thover: text-zinc-300 duration-300 rounded-md p-3 mb-3 max-md:p-1 max-md:mb-5 "
          >
        ...
        <nav className="flex flex-col text-x1 gap-2">
          ...
          <Link
          to ="/about"
          className="hover:bg-[#6556CD] Thover: text-zinc-300 duration-300 rounded-md p-3 max-md:p-1">
